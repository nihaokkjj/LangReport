...
export default function PluginsPage() {
  ...
  async function revoke(installationId: string) {
    ...
    setError(null);
    try {
      await apiFetch(`/api/v1/workspaces/${workspace.id}/plugins/${installationId}/revoke`, { method: "POST", headers: jsonHeaders, body: JSON.stringify({ reason: "当前账号在插件设置中撤销" }) });
