...
try {
  ...
  if (status === 0) status = run(["--filter", "@langreport/api", "exec", "tsx", "--test", "--test-concurrency=1", "test/integration/message-generation.integration.test.ts", "test/integration/plugins.integration.test.ts"]);
