...
export const routeContracts: RouteContract[] = [
  ...
  contract("POST", "/api/v1/projects/:projectId/data-assets/upload", "uploadDataAsset", ["Data Assets"], "上传并解析数据文件", { 201: dto({ asset: assetDto }, ["asset"]) }, { request: pathRequest("/api/v1/projects/:projectId/data-assets/upload", { body: json({ file: { type: "string", format: "binary", description: "待解析的数据文件" }, conversationId: { type: "string", format: "uuid", description: "来源 Conversation，可选" } }, ["file"]), consumes: ["multipart/form-data"] }), extraResponses: { 413: errorResponseSchema } }),
